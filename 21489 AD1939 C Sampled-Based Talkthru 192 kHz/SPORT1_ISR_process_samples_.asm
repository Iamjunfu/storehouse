...
.global _Transmit_DAC_Samples;
	...
	r0 = dm(_Left_Channel_Out3);	r0 = trunc f0 by r1;	dm(_tx0b_buf + Internal_DAC_L3) = r0;
	r0 = dm(_Left_Channel_Out4);	r0 = trunc f0 by r1;	dm(_tx0b_buf + Internal_DAC_L4) = r0;
	...
	r0 = dm(_Right_Channel_Out3);	r0 = trunc f0 by r1;	dm(_tx0b_buf + Internal_DAC_R3) = r0;
	r0 = dm(_Right_Channel_Out4);	r0 = trunc f0 by r1;	dm(_tx0b_buf + Internal_DAC_R4) = r0;
...
make_DAC_Pure_Tones:
	...
	dm(_tx0b_buf + Internal_DAC_R3) = r4;
	...
	r4 = dm(i4, m4);
	dm(_tx0b_buf + Internal_DAC_L4) = r4;
	dm(_tx0b_buf + Internal_DAC_R4) = r4;
